...
class TribuneProgressWidget(QWidget):
    ...
    def __init__(self, db: DatabaseRepository, parent: Optional[QWidget] = None):
        ...
        # Auto-update Tribune list daily (keep as scheduled timer)
        ...
        try:
            ...
            if achievement_date:
                ...
                try:
                    ...
                    logger.warning(f"Failed to parse Tribune achievement date '{achievement_date}': {e}")
    ...
    def _create_actions_section(self) -> QGroupBox:
        ...
        report_btn.setToolTip("Generate a Tribune award report to submit to the award manager")
        report_btn.clicked.connect(self._open_award_report_dialog)
        layout.addWidget(report_btn)

        app_btn = QPushButton("Generate Application")
        app_btn.setToolTip("Generate a Tribune award application to submit to the award manager")
    ...
    def _open_award_report_dialog(self) -> None:
        ...
        try:
            ...
            dialog = AwardReportDialog(self.db, award_type='Tribune', parent=self)
            dialog.exec()
        except Exception as e:
    ...
    def _open_award_application_dialog(self) -> None:
        ...
        try:
            ...
            # Pre-select Tribune award
            dialog.award_combo.setCurrentText('Tribune')
            dialog.exec()
        except Exception as e:
