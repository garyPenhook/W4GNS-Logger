...
class AwardApplicationGenerator:
    ...
    def _format_application_text(self, app_data: Dict[str, Any]) -> str:
        ...
        lines.append(f"Application Date: {datetime.now().strftime('%Y-%m-%d')}")
        lines.append(f"Application Generated: {datetime.now().strftime('%Y-%m-%d %H:%M:%S UTC')}")
        lines.append("")
    ...
    def _format_application_html(self, app_data: Dict[str, Any]) -> str:
        ...
        lines.append(f"<div class='info-row'><div class='info-label'>Application Date:</div><div>{datetime.now().strftime('%Y-%m-%d')}</div></div>")
        lines.append("</div>")
        ...
        lines.append(f"<p>Generated by W4GNS Logger on {datetime.now().strftime('%Y-%m-%d %H:%M:%S UTC')}</p>")
        lines.append("</div>")
